...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ElectroSpot — Factory-Direct Electrical Packages" },
      {
        name: "description",
        content:
          "Direct-from-factory electrical packages for home construction, plus cashback rewards for spotting new builds.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/electrospot-icon.svg", type: "image/svg+xml" },
    ],
  }),
